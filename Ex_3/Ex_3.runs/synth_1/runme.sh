...
HD_PWD='C:/Users/carl/fpga/Ex_3/Ex_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flowLED_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flowLED_top.tcl
