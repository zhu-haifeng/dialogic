...
HD_PWD='C:/Users/carl/fpga/statemachine/statemachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SeqDetector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SeqDetector.tcl
