...
HD_PWD='C:/Users/carl/fpga/statemachine/statemachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SeqDetector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SeqDetector.tcl -notrace
